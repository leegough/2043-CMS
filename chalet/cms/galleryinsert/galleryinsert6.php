...
// Check file size
if ($_FILES["fileToUpload8"]["size"] > 800000) {
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload8"]["tmp_name"], $target_file)) {
        ...
        $insertquery = "UPDATE gallery SET gallery6='$target_file' ";
        $insertresult = mysqli_query($conn, $insertquery) or die(mysqli_error($conn));

        echo "The file ". basename( $_FILES["fileToUpload8"]["name"]). " has been uploaded.<br><br>Please click <a href='../index.php'>here</a> to return to CMS";
    } else {
