...
// Check file size
if ($_FILES["fileToUpload7"]["size"] > 800000) {
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload7"]["tmp_name"], $target_file)) {
        ...
        $insertquery = "UPDATE gallery SET gallery5='$target_file' ";
        $insertresult = mysqli_query($conn, $insertquery) or die(mysqli_error($conn));

        echo "The file ". basename( $_FILES["fileToUpload7"]["name"]). " has been uploaded.<br><br>Please click <a href='../index.php'>here</a> to return to CMS";
    } else {
